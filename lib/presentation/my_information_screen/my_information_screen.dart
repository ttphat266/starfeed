import 'bloc/my_information_bloc.dart';
import 'models/my_information_model.dart';
...
class MyInformationScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<MyInformationBloc>(
      create: (context) => MyInformationBloc(MyInformationState(
        myInformationModelObj: MyInformationModel(),
      ))
        ..add(MyInformationInitialEvent()),
  ...
  Widget _buildMyInformationStack(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          CustomImageView(
            imagePath: ImageConstant.imgEllipse129,
            height: 220.v,
            width: 214.h,
          ...
          BlocSelector<MyInformationBloc, MyInformationState,
