import 'bloc/my_jobs_five_bloc.dart';
import 'models/my_jobs_five_model.dart';
...
class MyJobsFiveScreen extends StatelessWidget {
  const MyJobsFiveScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<MyJobsFiveBloc>(
      create: (context) => MyJobsFiveBloc(MyJobsFiveState(
        myJobsFiveModelObj: MyJobsFiveModel(),
      ))
        ..add(MyJobsFiveInitialEvent()),
      child: MyJobsFiveScreen(),
    );
  }
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            _buildJohnathonDoeButton(context),
                          ],
                        ),
                      ),
                    ),
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Row(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  _buildMessageTimezoneEditText(context),
                                  CustomImageView(
                            ...
                            Align(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                                  _buildMessageIThinkTopTwoAreButton(context),
                                  CustomImageView(
                                    imagePath: ImageConstant.imgRead,
                                    height: 17.adaptSize,
                                    width: 17.adaptSize,
  ...
  /// Section Widget
  Widget _buildJohnathonDoeButton(BuildContext context) {
  ...
  Widget _buildMessageEditText(BuildContext context) {
    return Padding(
      ...
      child:
          BlocSelector<MyJobsFiveBloc, MyJobsFiveState, TextEditingController?>(
  ...
  /// Section Widget
  Widget _buildMessageTimezoneEditText(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(bottom: 1.v),
      child:
          BlocSelector<MyJobsFiveBloc, MyJobsFiveState, TextEditingController?>(
        selector: (state) => state.messageTimezoneEditTextController,
        builder: (context, messageTimezoneEditTextController) {
          return CustomTextFormField(
            width: 207.h,
            controller: messageTimezoneEditTextController,
  ...
  /// Section Widget
  Widget _buildMessageIThinkTopTwoAreButton(BuildContext context) {
  ...
  /// Section Widget
  Widget _buildDeliverWorkButton(BuildContext context) {
    return CustomElevatedButton(
      text: "lbl_deliver_work".tr,
    );
  }

  /// Section Widget
  Widget _buildDeliverWork(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(
        left: 17.h,
        right: 21.h,
      ...
      child: Column(
        ...
        children: [
          SizedBox(height: 4.v),
          _buildDeliverWorkButton(context),
        ],
      ),
    );
  }
