import 'bloc/login_four_bloc.dart';
...
class LoginFourPage extends StatefulWidget {
  const LoginFourPage({Key? key})
      : super(
          key: key,
        );

  @override
  LoginFourPageState createState() => LoginFourPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<LoginFourBloc>(
      create: (context) => LoginFourBloc(LoginFourState(
        loginFourModelObj: LoginFourModel(),
      ))
        ..add(LoginFourInitialEvent()),
      child: LoginFourPage(),
    );
  }
}

class LoginFourPageState extends State<LoginFourPage>
    with AutomaticKeepAliveClientMixin<LoginFourPage> {
                ...
                Column(
                  children: [
                    Padding(
                      ...
                      child: BlocSelector<LoginFourBloc, LoginFourState,
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: 27.h),
                      child: BlocBuilder<LoginFourBloc, LoginFourState>(
                        builder: (context, state) {
                          return CustomTextFormField(
                            ...
                            suffix: InkWell(
                              onTap: () {
                                context.read<LoginFourBloc>().add(
