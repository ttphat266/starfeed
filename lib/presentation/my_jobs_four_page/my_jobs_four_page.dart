import 'bloc/my_jobs_four_bloc.dart';
import 'models/my_jobs_four_model.dart';
...
class MyJobsFourPage extends StatefulWidget {
  const MyJobsFourPage({Key? key})
      : super(
          key: key,
        );

  @override
  MyJobsFourPageState createState() => MyJobsFourPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<MyJobsFourBloc>(
      create: (context) => MyJobsFourBloc(MyJobsFourState(
        myJobsFourModelObj: MyJobsFourModel(),
      ))
        ..add(MyJobsFourInitialEvent()),
      child: MyJobsFourPage(),
    );
  }
}

class MyJobsFourPageState extends State<MyJobsFourPage>
    with AutomaticKeepAliveClientMixin<MyJobsFourPage> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MyJobsFourBloc, MyJobsFourState>(
