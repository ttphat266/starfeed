import 'bloc/edit_profile_one_bloc.dart';
...
class EditProfileOneScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<EditProfileOneBloc>(
      create: (context) => EditProfileOneBloc(EditProfileOneState(
        editProfileOneModelObj: EditProfileOneModel(),
      ))
        ..add(EditProfileOneInitialEvent()),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 24.v),
                  _buildAddThisServiceButton(context),
  ...
  Widget _buildNameEditText(BuildContext context) {
    return Padding(
      ...
      child: BlocSelector<EditProfileOneBloc, EditProfileOneState,
  ...
  /// Section Widget
  Widget _buildStoryPostStack(BuildContext context) {
    return Container(
      height: 55.v,
      width: 375.h,
  ...
  /// Section Widget
  Widget _buildAddThisServiceButton(BuildContext context) {
