import 'bloc/report_one_bloc.dart';
import 'models/report_one_model.dart';
import 'package:flutter/material.dart';
import 'package:phat_s_application1/core/app_export.dart';
import 'package:phat_s_application1/widgets/custom_text_form_field.dart';

class ReportOneScreen extends StatelessWidget {
  const ReportOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ReportOneBloc>(
      create: (context) => ReportOneBloc(ReportOneState(
        reportOneModelObj: ReportOneModel(),
      ))
        ..add(ReportOneInitialEvent()),
      child: ReportOneScreen(),
    );
  }
          ...
          child: Stack(
            ...
            children: [
              ...
              Padding(
                ...
                child: BlocSelector<ReportOneBloc, ReportOneState,
                    TextEditingController?>(
                  selector: (state) => state.privateMessageiconController,
                  builder: (context, privateMessageiconController) {
                    return CustomTextFormField(
                      width: 370.h,
                      controller: privateMessageiconController,
