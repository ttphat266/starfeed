import 'bloc/inbox_one_bloc.dart';
import 'models/inbox_one_model.dart';
import 'package:flutter/material.dart';
import 'package:phat_s_application1/core/app_export.dart';

class InboxOneScreen extends StatelessWidget {
  const InboxOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<InboxOneBloc>(
      create: (context) => InboxOneBloc(InboxOneState(
        inboxOneModelObj: InboxOneModel(),
      ))
        ..add(InboxOneInitialEvent()),
      child: InboxOneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<InboxOneBloc, InboxOneState>(
        ...
        return SafeArea(
          child: Scaffold(
            ...
            body: SizedBox(
              ...
              child: Column(
                children: [
                  _buildHiconBoldMenuStack(context),
                  SizedBox(height: 2.v),
                  _buildLeonardLoteaRow(context),
                  SizedBox(height: 6.v),
                  _buildLutaLiaRow(context),
                  SizedBox(height: 8.v),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 30.h),
                    child: _buildLeonardiBertRow(
                      context,
                      titleText: "lbl_fab_yola".tr,
                      messageText: "msg_you_did_not_lmao".tr,
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: _buildLeonardiBertRow(
                      context,
                      titleText: "lbl_leonardi_bert".tr,
                      messageText: "msg_you_did_not_lmao".tr,
                    ),
                  ),
                  SizedBox(height: 14.v),
                  _buildPailoArbitRow(context),
                  SizedBox(height: 13.v),
                  _buildSujanSujanRow(context),
                  SizedBox(height: 14.v),
                  _buildLutaLiaRow1(context),
                  SizedBox(height: 5.v),
                ],
              ),
            ),
            bottomNavigationBar: _buildFabYolaStack(context),
          ),
        );
      },
    );
  ...
  /// Section Widget
  Widget _buildHiconBoldMenuStack(BuildContext context) {
    return SizedBox(
      height: 220.v,
      width: 410.h,
      child: Stack(
  ...
  /// Section Widget
  Widget _buildLeonardLoteaRow(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 30.h),
      child: Row(
  ...
  /// Section Widget
  Widget _buildLutaLiaRow(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(
        left: 23.h,
        right: 17.h,
  ...
  /// Section Widget
  Widget _buildPailoArbitRow(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 30.h),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
  ...
  /// Section Widget
  Widget _buildSujanSujanRow(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 30.h),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
  ...
  /// Section Widget
  Widget _buildLutaLiaRow1(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 30.h),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
  ...
  /// Section Widget
  Widget _buildFabYolaStack(BuildContext context) {
    return SizedBox(
      height: 121.v,
      width: double.maxFinite,
      child: Stack(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  _buildFollowing1(
                    context,
                    dynamicText1: "lbl_fab_yola".tr,
                    dynamicText2: "msg_you_did_not_lmao".tr,
                  ),
                  Opacity(
                    opacity: 0.4,
                    child: CustomImageView(
