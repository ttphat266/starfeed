import 'bloc/login_eight_bloc.dart';
...
class LoginEightScreen extends StatelessWidget {
  const LoginEightScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<LoginEightBloc>(
      create: (context) => LoginEightBloc(LoginEightState(
        loginEightModelObj: LoginEightModel(),
      ))
        ..add(LoginEightInitialEvent()),
      child: LoginEightScreen(),
    );
  }
          ...
          child: Column(
            children: [
              Align(
                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    ...
                    children: [
                      CustomImageView(
                        imagePath: ImageConstant.imgEllipse137,
                        height: 188.v,
                        width: 197.h,
                        alignment: Alignment.centerRight,
                      ),
              ...
              Padding(
                ...
                child: BlocSelector<LoginEightBloc, LoginEightState,
              ...
              CustomImageView(
                imagePath: ImageConstant.imgEllipse218,
                height: 220.v,
                width: 151.h,
