import 'bloc/delivery_one_bloc.dart';
import 'models/delivery_one_model.dart';
...
class DeliveryOneScreen extends StatelessWidget {
  const DeliveryOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<DeliveryOneBloc>(
      create: (context) => DeliveryOneBloc(DeliveryOneState(
        deliveryOneModelObj: DeliveryOneModel(),
      ))
        ..add(DeliveryOneInitialEvent()),
      child: DeliveryOneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<DeliveryOneBloc, DeliveryOneState>(
